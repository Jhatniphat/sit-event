...
const handleGrantStaff = (id: string) => {
  router.push({ name: 'GrantStaffView', params: { id } })
}
  ...
  <div class="min-h-screen bg-gray-50/50 p-8">
    <div class="max-w-7xl mx-auto space-y-6">
      <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 class="text-3xl font-bold tracking-tight text-gray-900" id="heading-event-management">
            Event Management
          </h1>
            ...
            <tbody class="divide-y divide-gray-100">
              ...
              >
                ...
                <td class="px-6 py-4 text-right space-x-2">
                  <button
                    @click="router.push({ name: 'EventDashboard', params: { id: event.id } })"
                  ...
                  <button
                    @click="router.push({ name: 'ParticipantApproval', params: { id: event.id } })"
