    ...
    <div class="max-w-7xl mx-auto space-y-6">
      <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div class="flex flex-row gap-2">
          <BaseButton @click="handleCreate" label="+ New Event" class="bg-black text-white px-4 py-2" />
        </div>
      </div>
              ...
              <tr v-for="event in events" :key="event.id" class="hover:bg-gray-50/80 transition-colors">
                ...
                <td class="px-6 py-4 text-gray-600">
                  <div class="flex flex-col">
                    ...
                    <span class="text-xs text-gray-400">to
                      {{
                ...
                <td class="px-6 py-4 text-gray-600">
                  <div class="flex flex-wrap gap-1">
                    <span v-for="aud in event.targetAudience" :key="aud"
                ...
                <td class="px-6 py-4 text-right space-x-2">
                  ...
                  <button @click="router.push({ name: 'ParticipantApproval', params: { id: event.id } })"
                    class="p-2 text-gray-500 hover:text-green-600 hover:bg-green-50 rounded-md transition-colors"
                  ...
                  <button @click="handleEdit(event.id)"
                  ...
                  <button @click="handleFormsList(event.id)"
